...
declare function traverse<S>(parent: t.Node, opts: TraverseOptions<S>, scope: Scope | null | undefined, state: S, parentPath?: NodePath_Final, visitSelf?: boolean): void;
...
export { Binding, type BindingKind, type ExplodedTraverseOptions, type ExplodedVisitor, Hub, type HubInterface, NodePath_Final as NodePath, Scope, type TraverseOptions, type VisitWrapper, type Visitor, type VisitorBase, traverse as default, __visitors_ts as visitors };
